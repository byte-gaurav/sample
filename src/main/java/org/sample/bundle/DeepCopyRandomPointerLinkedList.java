...
import org.sample.dto.NodeWithRandomPointer;
...
//        while (temp != null) {
//            if (originalNodes.contains(temp)) {
//                System.out.println("original node present" + temp);
//            }
//            if (temp.next != null && originalNodes.contains(temp.next)) {
//                System.out.println("next original node present" + temp.next.val);
//            }
//            if (temp.random != null && originalNodes.contains(temp.random)) {
//                System.out.println("random original node present" + temp.random.val);
//            }
//            temp = temp.next;
//        }
    }
